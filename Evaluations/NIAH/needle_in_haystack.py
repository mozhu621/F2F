...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
                 ...
                 #needle="\nThe special magic Singapore number is: 123123\n",
                 
                 haystack_dir="PaulGrahamEssays",
                 # retrieval_question="The special magic Singapore number is: ?",
                 retrieval_question="What is the best thing to do in San Francisco?",
                 results_version = 1,
                 context_lengths_min = 1000,
                 context_lengths_max = 32000,
                 context_lengths_num_intervals = 32,
    ...
    def evaluate_and_log(self, context_length, depth_percent):
        ...
        if self.save_results:
            ...
            if not os.path.exists(f'results/graph_ours/{save_name}'):
                os.makedirs(f'results/graph_ours/{save_name}')
            
    
            # Save the result to file for retesting
            p = f'results/graph_ours/{save_name}/{context_file_location}_results.json'
...
if __name__ == "__main__":
    ...
    parser.add_argument('-n', '--num_intervals', metavar='N', type=int, help='a number')
...
# CUDA_VISIBLE_DEVICES=0,1,2,3 python needle_in_haystack_ours.py --mask_top 0 --s 5000 --e 80000  --model_path yaofu/llama-2-7b-80k
# CUDA_VISIBLE_DEVICES=4,5,6,7 python needle_in_haystack_ours.py --mask_top 0 --s 5000 --e 80000 --model_path /data/yuhao/Save_model/Long_context/Llama-2-7b-dolly-80k-2epoch/
# CUDA_VISIBLE_DEVICES=4,5,6,7 python needle_in_haystack_ours.py --mask_top 0 --s 10000 --e 32000 --model_path /data/yuhao/Save_model/Long_context/Llama-2-7b-dolly-80k-2epoch/